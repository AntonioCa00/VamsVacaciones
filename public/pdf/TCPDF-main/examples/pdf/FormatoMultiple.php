...
$pdf->Cell(103, 6, $datosEmpleado['nombres'].' '.$datosEmpleado['apellidoP']. ' '.$datosEmpleado['apellidoM'], 1, 0, 'L', 0); // Texto normal
...
$pdf->Cell(37, 6, $datosEmpleado['fecha'], 1, 1, 'C', 0); // Texto normal
...
$pdf->Cell(85, 6, $datosEmpleado['puesto'], 1, 0, 'L', 0); // Texto normal

$pdf->SetFont('helvetica', 'B', 12); // Negritas para "Fecha:"
$pdf->Cell(18, 6, 'Area:', 1, 0, 'L', 1); // Negritas solo en "Fecha:"

$pdf->SetFont('helvetica', '', 10); // Normal para la fecha
$pdf->Cell(55, 6, $datosEmpleado['area'], 1, 1, 'C', 0); // Texto normal
