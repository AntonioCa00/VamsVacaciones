...
$pdf->MultiCell(30, 10, '', 1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
...
$pdf->Cell(22, 6, 'Nombre:', 1, 0, 'L', 1); // Negritas solo en "Nombre:"

$pdf->SetFont('helvetica', '', 10); // Normal para el texto después de ":"
$pdf->Cell(103, 6, '', 1, 0, 'L', 0); // Texto normal

$pdf->SetFont('helvetica', 'B', 12); // Negritas para "Fecha:"
$pdf->Cell(18, 6, 'Fecha:', 1, 0, 'L', 1); // Negritas solo en "Fecha:"

$pdf->SetFont('helvetica', '', 10); // Normal para la fecha
$pdf->Cell(37, 6,'', 1, 1, 'C', 0); // Texto normal

// Segunda fila
$pdf->SetFont('helvetica', 'B', 12); // Negritas para "Puesto:"
$pdf->Cell(22, 6, 'Puesto:', 1, 0, 'L', 1); // Negritas solo en "Puesto:"

$pdf->SetFont('helvetica', '', 10); // Normal para el puesto
$pdf->Cell(85, 6, '', 1, 0, 'L', 0); // Texto normal

$pdf->SetFont('helvetica', 'B', 12); // Negritas para "Fecha:"
$pdf->Cell(18, 6, 'Area:', 1, 0, 'L', 1); // Negritas solo en "Fecha:"

$pdf->SetFont('helvetica', '', 10); // Normal para la fecha
$pdf->Cell(55, 6, '', 1, 1, 'C', 0); // Texto normal
...
$pdf->Rect($pdf->GetX() - 10, $pdf->GetY() + 0.6, $cuadroAncho, $cuadroAlto,''); // 'F' para llenar
