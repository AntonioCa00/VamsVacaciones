            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('duranteEnc') }}" class="btn btn-info">Solicitar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('ausentarseEnc') }}" class="btn btn-info">Solicitar</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        @if (session('dias_disponibles') > 0)
                            <a href="{{ route('vacacionesEnc') }}" class="btn btn-info">Solicitar</a>
                        @else
