    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a class="btn btn-primary" href="{{ route('vacacionesEnc') }}">Solicitar vacaciones</a>
            </div>
            <div class="card-body">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('updateVacacionEnc', $historial->id_vacacion) }}"
                                                                method="POST">
