                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('aprobarAdm') }}" method="POST">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    var calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        hiddenDays: [0],
                        events: {
                            url: 'Administrador/programacion',
                            method: 'GET',
                            failure: function() {
                        ...
                        eventClick: function(info) {
                            if (info.event.extendedProps.status === '0') {
                                ...
                                // Si el estatus no es '0', mostrar alerta con los días tomados
                                alert(info.event.extendedProps.dias + ' Días tomados de: ' + info.event.title);
                            }
                        }
                    });
