        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('createPersonal') }}" method="POST">
                    ...
                    visionName"
                            type="text" class="form-control" placeholder="Numero de empleado asignado al usuario"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    visionName"
                            type="text" class="form-control" placeholder="Escribe el/los nombre(s) del usuario" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="rol" class="form-control" id="rol" required>
                            <option value="" selected disabled>Selecciona el rol que se le asignará al usuario
                            </option>
                            ...
                            <option value="General" {{ old('rol') == 'General' ? 'selected' : '' }}>Usuario General
                            </option>
                        </select>
                    </div>
