    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a class="btn btn-primary" href="{{ route('vacaciones') }}">Solicitar vacaciones</a>
            </div>
            <div class="card-body">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('updateVacacion', $historial->id_vacacion) }}"
                                                                method="POST">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-secondary" type="button"
                                                                data-dismiss="modal">cancelar</button>
                                                            <form
                                                                action="{{ route('deleteVacacion', $historial->id_vacacion) }}"
                                                                method="POST">
                                                                @csrf
                                                                {!! method_field('DELETE') !!}
                                                                <button type="submit"
